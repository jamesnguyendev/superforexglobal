...
export default function STPAccounts() {
  ...
  return (
    <>
      <Banner
        imgDesktop={"https://ik.imagekit.io/3idyffxxb/New%20Folder/quality_restoration_20241227105900533.jpg?updatedAt=1735552761374"}
        imgMobile={"https://ik.imagekit.io/3idyffxxb/New%20Folder/quality_restoration_20241227105900533%201212.jpg?updatedAt=1735552761041"}
        ...
        <Grid container spacing={10} className="justify-center items-center">
          <Grid item size={{ sm: 12, md: 6 }}>
            ...
            <Typography>
              ...
              starting balance of just $50. The Standard account is a good choice
              for experienced traders who are looking to trade larger volumes,
              with a larger lot size and a support of Forex Copy system.
            </Typography>
            <br />
            <Typography>
      ...
      >
        ...
        <Grid container spacing={10}>
          ...
          >
            <img
              src={
                "https://ik.imagekit.io/3idyffxxb/New%20Folder/card-standard%202.jpg?updatedAt=1735630688021"
              }
              alt={"img"}
            />
          </Grid>
