      ...
      <Container maxWidth="lg">
        <Stack className="py-12 text-default items-center">
          ...
          <p className="p-2 font-bold text-xl">
            A great way to cut your trading costs with ECN technology in Crypto
          </p>
        </Stack>
      </Container>
        ...
        <div className={"grid grid-cols-1 items-center gap-24 lg:grid-cols-2"}>
          ...
          <div className="flex flex-col items-start gap-y-6">
            <h2 className={"text-5xl font-semibold text-default"}>
              Cutting-edge technology with big liquidity in the crypto markets
            </h2>
            <p className={"m-0 font-normal text-default"}>
              An ECN account is an important part of Forex trading. It allows
              you to trade on the interbank market, which gives you access to
              some of the best liquidity in the world. When you open an ECN
              account with a reputable broker, you can be sure that you are
            ...
            <div className="flex flex-col gap-y-2">
              <div className="inline-flex items-center">
                ...
                <div className="ms-2 font-sohne text-sm font-semibold text-default">
                  Trade Cryptocurrencies with floating spreads
                </div>
              </div>
              <div className="inline-flex items-center">
                <svg
              ...
              <div className="inline-flex items-center">
                ...
                <div className="ms-2 text-sm font-semibold text-default">
                  Direct order execution on Cryptocurrency trades
                </div>
              </div>
              <div className="inline-flex items-center">
                <svg
                ...
                <div className="ms-2 text-sm font-semibold text-default">
                  Award winning ECN Crypto broker
                </div>
              </div>
            </div>
            <div onClick={handleOpen}>
        ...
        <Grid container spacing={10} className="justify-center items-center">
          <Grid item size={{ sm: 12, md: 6 }}>
            <p className="font-bold text-5xl">
              Why Should You Open an ECN Crypto Account?
            </p>
            <br />
            <Typography>
            ...
            <br />
            <Typography>
              Our ECN Crypto account is perfectly suited for traders wishing to
              experience ECN trading on cryptocurrencies. The ECN Crypto account
              has been set up to make trading with cryptocurrencies as
              comfortable as possible for you and is suitable for any trading
              strategy.
            </Typography>
          </Grid>
          <Grid
